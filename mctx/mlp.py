...
@jax.jit
def SGD(params, grads, lr: float = 0.1):
...
@jax.jit
def train_one_epoch(rng, params, X_train, y_train, batch_size: int = 50):
...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test = train_test_split(jnp.array(iris_dataset['data']), jnp.array(iris_dataset['target']),
