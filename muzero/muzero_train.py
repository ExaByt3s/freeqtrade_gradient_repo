...
dataframe = pandas_datareader.data.DataReader(ticker_symbol, 'yahoo', parameter['history']['start'],
                                              parameter['history']['end'])
df = dataframe
df['SP500'] = dataframe['Close'].values
